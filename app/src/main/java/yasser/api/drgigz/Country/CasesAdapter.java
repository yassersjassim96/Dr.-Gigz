...
public class CasesAdapter extends RecyclerView.Adapter<CasesAdapter.ViewHolder> implements Filterable {
    ...
    public CasesAdapter(List<CovidCountry> covidCountries, Context context){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_cases, parent, false);
