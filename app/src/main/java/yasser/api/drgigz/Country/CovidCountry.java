...
public class CovidCountry implements Parcelable {
    String mCovidCountry, mTodayCases, mTodayDeaths, mRecovered, mActive, mCritical, mFlags;
    int mCases, mDeaths;

    public CovidCountry(String mCovidCountry, int mCases, String mTodayCases, int mDeaths, String mTodayDeaths, String mRecovered, String mActive, String mCritical, String mFlags) {
