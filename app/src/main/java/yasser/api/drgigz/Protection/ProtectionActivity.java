...
public class ProtectionActivity extends AppCompatActivity {
    ...
    private SlideAdapterProtection myadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Locale.getDefault().getLanguage().contentEquals("ar")){
            setContentView(R.layout.activity_protection_ar);
        } else {
            setContentView(R.layout.activity_protection);
        }

        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("الوقاية");
        ...
        myadapter = new SlideAdapterProtection(this);
